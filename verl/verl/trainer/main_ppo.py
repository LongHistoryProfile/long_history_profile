...
# from verl.trainer.ppo.my_ray_trainer_v2 import  LSTMRayPPOTrainer as RayPPOTrainer
...
class TaskRunner:
    ...
    def run(self, config):
        ...
        TrainerCls = load_class(config.trainer.get("trainer_cls", "verl.trainer.ppo.ray_trainer.RayPPOTrainer"))
        print(f"Using Trainer class: {TrainerCls.__name__}")
        # TrainerCls=RayPPOTrainer
...
def create_rl_dataset(data_paths, data_config, tokenizer, processor, is_train=True, max_samples: int = -1):
    ...
    from verl.utils.dataset.rl_dataset import RLHFDataset,MovieMemoryControllerDataset,MovieProfileDataset
